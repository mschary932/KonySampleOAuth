	...
	//	var animConf = getAnimationConfig();
      var animConf =    { 
		...
		var swipeAnimtion1 = { definition : animObj,
					config : animConf,
					callbacks : null};
      var jsonObj={rows:rowList, widgets : ["flxcDriveContainer"], animation: swipeAnimtion1};
      kony.print("\nJSONObj:- "+JSON.stringify(jsonObj)); 
      //context.widgetInfo.animateRows(jsonObj);
      if(hasgesture)
        frmOneDrive.segOnedrive.animateRows(jsonObj);
  ...
  function flx_onclick(widget, context){
	...
	var animDefinitionOne = {0  : {"transform":transformProp3},
        					100 : {"transform":transformProp1}};
                             ...
                             var animConfig = {"duration":0.3,"iterationCount":1,"delay":0,"fillMode":kony.anim.FILL_MODE_FORWARDS	};
